...
(function(root) {
  ...
  if (typeof(exports) !== "undefined" && exports._) {
	...
	if(global)
	{
		Parse.localStorage = global.window.localStorage;
		Parse.XMLHttpRequest = global.window.XMLHttpRequest;
	}
	else
	{
...
(function(root) {
  ...
  _.extend(Parse.History.prototype, Parse.Events,
    ...
    start: function(options) {
      ...
      var oldIE = (isExplorer.exec(window.navigator.userAgent.toLowerCase()) &&
                   (!docMode || docMode <= 7));
    ...
    navigate: function(fragment, options) {
      ...
      if (this._hasPushState) {
        ...
        window.history[replaceOrPush]({}, window.document.title, frag);
